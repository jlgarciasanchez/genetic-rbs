...
; Plantilla que contiene los datos de las filas de las matrices que forman cada solución.
(deftemplate fila
        (slot idSolucion)
        (slot fila)
        (multislot datos)
...
; Regla que invoca al módulo de reemplazo.
(defrule Reemplazo
        (reemplazo)
        =>
        (assert (evaluacion))
